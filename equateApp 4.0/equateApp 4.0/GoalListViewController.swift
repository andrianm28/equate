...
class GoalListViewController: UIViewController {
    ...
    func createArray() -> [Goal] {
        ...
        let goal1 = Goal(image: #imageLiteral(resourceName: "Group 16"), title: "Karaoke", description: "lorem ipsum", time: "09.00 AM")
        let goal2 = Goal(image: #imageLiteral(resourceName: "Group 9"), title: "Read a book", description: "lorem ipsum", time: "09.00 AM")
        let goal3 = Goal(image: #imageLiteral(resourceName: "Group 7"), title: "Running", description: "lorem ipsum", time: "09.00 AM")
        let goal4 = Goal(image: #imageLiteral(resourceName: "Group 20"), title: "Bowling", description: "lorem ipsum", time: "09.00 AM")
        let goal5 = Goal(image: #imageLiteral(resourceName: "Group 28"), title: "Meeting", description: "lorem ipsum", time: "09.00 AM")
        let goal6 = Goal(image: #imageLiteral(resourceName: "Group 11"), title: "Baking", description: "lorem ipsum", time: "09.00 AM")
